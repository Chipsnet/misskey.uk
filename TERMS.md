...
この利用規約（以下，「本規約」といいます。）は，MinatoServer（以下，「当団体」といいます。）がmisskey.uk上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
...
1. 本サービスにおいては，登録希望者が本規約に同意の上，当団体の定める方法によって利用登録をすることにより, 利用登録が完了するものとします。
